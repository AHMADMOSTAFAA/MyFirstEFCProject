...
namespace Sportify.DAL.Migrations
{
    ...
    [Migration("20250224011446_Added Images and changed relation between user and place to one to many")]
    partial class AddedImagesandchangedrelationbetweenuserandplacetoonetomany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sportify.DAL.Entities.Shop", b =>
                {
                    b.HasOne("Sportify.DAL.Entities.PlaceOfInterest", "Place")
                        .WithOne("Shop")
                        .HasForeignKey("Sportify.DAL.Entities.Shop", "PlaceId")
                        .OnDelete(DeleteBehavior.Cascade);
